...
class TestBaseGeometry(SingleNif):
    ...
    """Vertices generated by b_create_base_geometry. For testing."""
    ...
    def b_check_geom(self, b_mesh):
        ...
        desired_verts = {
            tuple(round(co, 4) for co in vert)
            for vert in self.b_verts}
        nose.tools.assert_set_equal(verts, desired_verts)
