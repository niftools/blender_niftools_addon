...
[Provide version information for the Blender Nif Plugin the issue occures with, available in Blender in the Add-On section]
...
## Steps to Reproduce
[Ordered list of the steps required for recreating the issue]
 #. 
...
### Console Output
[Attach the output of the console, Enable via Window -> Toggle Console]
