...
FILES="scripts/nif_import.py scripts/nif_export.py scripts/nif_common.py scripts/mesh_weightsquash.py scripts/mesh_hull.py ChangeLog README.html install.sh"
