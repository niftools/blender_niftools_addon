...
FILES="scripts/nif_import.py scripts/nif_export.py scripts/bpymodules/nif_common.py scripts/bpymodules/nif_test.py scripts/mesh_weightsquash.py scripts/mesh_hull.py scripts/object_setbonepriority.py ChangeLog README.html install.sh install.bat"
