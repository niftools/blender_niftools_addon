...
@for %%A in (scripts\nif_import.py, scripts\nif_export.py, scripts\mesh_weightsquash.py, scripts\mesh_hull.py, scripts\object_setbonepriority.py, scripts\object_savebonepose.py, scripts\object_loadbonepose.py) do copy "%%A" %BLENDERSCRIPTS%
