...
set VERSION=2.4.11
set FILES=scripts\import_nif.py scripts\export_nif.py scripts\mesh_weightsquash.py scripts\mesh_hull.py scripts\object_setbonepriority.py scripts\object_savebonepose.py scripts\object_loadbonepose.py scripts\bpymodules\nif_common.py scripts\bpymodules\nif_test.py ChangeLog README.html install.sh install.bat
